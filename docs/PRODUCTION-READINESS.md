...
|---|---:|---:|---|
| Flujo forense y reglas de negocio | 15 | 13 | Cuatro etapas, autorización, custodia, hallazgos, revisión independiente y cierre; falta reapertura controlada y RBAC real. |
...
| Motores de análisis | 20 | 9 | Texto/scripts, IOC, capas codificadas, firmas binarias, entropía y strings; faltan Windows, navegador, SQLite, PE profundo, red, archivos y sandbox dinámico. |
| Seguridad de aplicación | 15 | 7 | Antiforgery, almacenamiento fuera de web, límites, CSP, cabeceras y rate limiting; faltan identidad, MFA, RBAC, cifrado y gestión de secretos. |
...
| **Total verificable** | **100** | **56** | **No liberar a clientes hasta cerrar los bloqueadores de identidad, persistencia, sandbox, firma y recuperación.** |
