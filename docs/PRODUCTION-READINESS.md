...
| Seguridad de aplicación | 15 | 14 | Antiforgery, límites, CSP, rate limiting, MFA TOTP, RBAC, bloqueo e invalidación de sesiones, cifrado AES-256-GCM de evidencia en reposo con clave maestra gestionada, gestión de secretos documentada, sondas DAST automatizadas y escáner externo OWASP ZAP baseline programado en CI (`.github/workflows/dast.yml`, reglas en `.github/zap/rules.tsv`, evidencia archivada 90 días); falta DAST sobre contexto autenticado. |
